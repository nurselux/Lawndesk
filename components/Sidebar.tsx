...
import {
  ...
  Receipt, Inbox, HardHat, Settings, LogOut, X, Menu, Clock, UserCircle, Lock,
} from 'lucide-react'
...
export default function Sidebar() {
  ...
  const [isPro, setIsPro] = useState(true) // default true to avoid flashing locks on load
  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      if (session?.user?.id) {
        ...
        setIsPro(plan === 'pro' || status === 'trialing')
      }
    }
    checkUser()
  }, [fetchCounts])
